...
import com.if1001exemplo1.tccvaseguro.basicas.MensagemEmail;
...
public class SendMail {
    ...
    public static void sendMail(final Context context, final Activity activity, LatLng location, MensagemEmail mensagemEmail) {
        ...
        String emailBody =  mensagemEmail.getTexto() + "/n Minha localização é: " + mensagemEmail.getLatitude() +
                " , "+ mensagemEmail.getLongitude() + "!"+
