...
public class LocationDatasController {
    ...
    public void clearAllDangerousLocations() {
        ...
        ldDB.getWritableDatabase().delete(LocationDatasOpenHelper.TABLE_COORDINATES_ALERT, null, null);

    }

    public void clearAllRoutes(){
        ldDB.getWritableDatabase().delete(LocationDatasOpenHelper.TABLE_ROUTES, null, null);
    }
...
//insere LPs
    public String dangerousLocationsInsert(DangerousLocations dangerousLocations){
        ...
        check = db.insert(LocationDatasOpenHelper.TABLE_COORDINATES_ALERT, null, values);
    ...
    public String inserRoute(Route route){
        ...
        check = db.insert(LocationDatasOpenHelper.TABLE_ROUTES, null, values);
    ...
    public Cursor loadCoordinatesAlarm(Context context){
        ...
        cursor = db.query(LocationDatasOpenHelper.TABLE_COORDINATES_ALERT, ldDB.COLUMNS_COORDINATES_ALERT, null, null, null, null, null, null);
...
//pra poder marcar os locais perigosos no mapa
    ...
    public boolean isRouteExists(String originAdress, String destinationAdress) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + LocationDatasOpenHelper.TABLE_ROUTES
...
//método pro reload
    public List<String> getLastDestination() {
        ...
        Cursor cursor = db.query(LocationDatasOpenHelper.TABLE_ROUTES, ldDB.COLUMNS_ROUTE, null, null, null, null, null, null);
